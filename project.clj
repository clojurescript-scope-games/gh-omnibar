(defproject github-omnibar "0.1.0-SNAPSHOT"
  ...
  :ring {:handler github-omnibar.handler/app
         :uberwar-name "github-omnibar.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "github-omnibar.jar"

  :main github-omnibar.server
  ...
  :profiles {:dev {:repl-options {:init-ns github-omnibar.repl}
                   ...
                   :cljsbuild {:builds {:app {:source-paths ["env/dev/cljs"]
                                              :compiler {:main "github-omnibar.dev"
                                                         :source-map true}}
